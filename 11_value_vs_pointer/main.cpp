...
int main() {
    ...
    {
        lab::print_qor("Pointer Semantics", COUNT * (sizeof(Entity*) + sizeof(Entity)));
    ...
    {
        lab::print_qor("Value Semantics", COUNT * sizeof(Entity));
    ...
    {
        lab::print_qor("SoA Semantics", COUNT * (sizeof(float) * 2));
