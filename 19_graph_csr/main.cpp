...
int main() {
    ...
    size_t naive_mem = NUM_NODES * sizeof(std::vector<int>) + (NUM_NODES * EDGES_PER_NODE * sizeof(int));
    size_t csr_mem = csr.edges.size() * sizeof(int) + csr.offsets.size() * sizeof(size_t);

    lab::print_qor("Naive Graph", naive_mem);
    lab::print_qor("CSR Graph", csr_mem);
